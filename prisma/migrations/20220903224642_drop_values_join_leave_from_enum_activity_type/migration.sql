/*
  ...
  - The values [join,leave] on the enum `activity_type` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "activity_type_new" AS ENUM ('file', 'text', 'media', 'call', 'other');
